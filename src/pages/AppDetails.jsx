    ...
    <Page onPageInit={pageInit} onPageBeforeRemove={pageDestroy}>
      ...
      <div className={`block app-description ${showFullDescription ? 'app-description-full' : ''}`}>
        <div className="app-privacy">
          <div className="app-privacy-text" dangerouslySetInnerHTML={createAppPrivacy()} />
          <Link onClick={() => setShowFullDescription(true)}>more</Link>
        </div>
        ...
        <div className="block app-reviews">
          <div className="app-review">
            <div className="app-review-text">
              <i className="f7-icons">viewfinder_person_fill</i>
            </div>
            <div className="app-review">
              <span><b>Data Used to Track You</b></span>
            </div>
            <div className="app-review">
              <span>The following data may be used to track you across apps and websites owned by other companies:</span>
            </div>
            <div className="app-infoicon">
              <i className="icon f7-icons color-white">info_round_fill</i>
              Contact info
              <i className="icon f7-icons color-white">text_rectangle</i>
            </div>
            <div className="app-review">
              <span><b>Data Used to Track You</b></span>
            </div>
